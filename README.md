...
| Area          | Technologies                                              |
| ------------- | --------------------------------------------------------- |
| **Backend**   | PHP · Laravel · REST APIs · PostgreSQL · Redis · RabbitMQ |
| **Frontend**  | React · TypeScript                                        |
| **Mobile**    | Flutter · Dart · BLoC                                     |
| **DevOps**    | Docker · Nginx · GitHub Actions · Mindep · Tailscale      |
...
<p align="left">
  ...
  <a href="https://openai.com/codex/" target="_blank" rel="noreferrer"><img src="https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/codex-openai/color.svg" alt="Codex / OpenAI" width="40" height="40"/></a>
</p>
